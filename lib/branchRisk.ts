...
export const branchRiskDemoSources: Record<BranchRiskSourceKey, BranchSourceRecord[]> = {
  complaints: [
    { complaintId: 'CMP-001-01', complaintDate: '2026-09-02', branch: 'Branch 001', complaintCategory: 'General service', complaintDescription: 'Minor delay at counter', status: 'Closed', outcome: 'Resolved', severity: 'Low' },
    { complaintId: 'CMP-002-01', complaintDate: '2026-09-03', branch: 'Branch 002', complaintCategory: 'Teller service', complaintDescription: 'Customer felt rushed during transaction', status: 'Closed', outcome: 'Resolved', severity: 'Low' },
    { complaintId: 'CMP-002-02', complaintDate: '2026-09-06', branch: 'Branch 002', complaintCategory: 'Service quality', complaintDescription: 'Long queue during peak hours', status: 'Open', outcome: '', severity: 'Medium' },
    { complaintId: 'CMP-003-01', complaintDate: '2026-09-02', branch: 'Branch 003', complaintCategory: 'Teller service', complaintDescription: 'Cash handling delay', status: 'Open', outcome: '', severity: 'Medium' },
    { complaintId: 'CMP-003-02', complaintDate: '2026-09-04', branch: 'Branch 003', complaintCategory: 'Incorrect information from branch staff', complaintDescription: 'Customer given wrong fee information', status: 'Under Review', outcome: '', severity: 'High' },
    { complaintId: 'CMP-003-03', complaintDate: '2026-09-07', branch: 'Branch 003', complaintCategory: 'Branch operations', complaintDescription: 'Repeated system downtime at branch', status: 'Open', outcome: '', severity: 'High' },
    ...
    { complaintId: 'CMP-006-01', complaintDate: '2026-09-01', branch: 'Branch 006', complaintCategory: 'Teller service', complaintDescription: 'Customer alleges cash shortfall after withdrawal', status: 'Under Review', outcome: '', severity: 'High' },
    { complaintId: 'CMP-006-02', complaintDate: '2026-09-04', branch: 'Branch 006', complaintCategory: 'Branch staff', complaintDescription: 'Unprofessional conduct reported', status: 'Open', outcome: '', severity: 'High' },
    { complaintId: 'CMP-006-03', complaintDate: '2026-09-06', branch: 'Branch 006', complaintCategory: 'Cash handling', complaintDescription: 'Dispute over deposit amount recorded', status: 'Open', outcome: '', severity: 'Critical' },
    { complaintId: 'CMP-007-01', complaintDate: '2026-09-03', branch: 'Branch 007', complaintCategory: 'Teller service', complaintDescription: 'Transaction processed incorrectly', status: 'Open', outcome: '', severity: 'Medium' },
    { complaintId: 'CMP-007-02', complaintDate: '2026-09-05', branch: 'Branch 007', complaintCategory: 'Service quality', complaintDescription: 'Extended wait time for cash deposit', status: 'Under Review', outcome: '', severity: 'High' },
  ],
  gl: [
    { transactionId: 'GL-002-01', branch: 'Branch 002', userId: 'E202', employeeId: 'E202', date: '2026-09-03', time: '23:10', glAccount: '7001', transactionType: 'Manual Adjustment', amount: '3100', manualEntry: 'Yes', reversal: 'No', authorizationUser: 'M203' },
    { transactionId: 'GL-003-01', branch: 'Branch 003', userId: 'E304', employeeId: 'E304', date: '2026-09-02', time: '21:40', glAccount: '7002', transactionType: 'Manual Adjustment', amount: '5200', manualEntry: 'Yes', reversal: 'No', authorizationUser: 'M304' },
    { transactionId: 'GL-003-02', branch: 'Branch 003', userId: 'E304', employeeId: 'E304', date: '2026-09-05', time: '22:55', glAccount: '7002', transactionType: 'Manual Adjustment', amount: '4700', manualEntry: 'Yes', reversal: 'Yes', authorizationUser: 'M304' },
    { transactionId: 'GL-003-03', branch: 'Branch 003', userId: 'E305', employeeId: 'E305', date: '2026-09-07', time: '23:20', glAccount: '7003', transactionType: 'Manual Adjustment', amount: '6100', manualEntry: 'Yes', reversal: 'No', authorizationUser: 'M304' },
    ...
    { transactionId: 'GL-006-01', branch: 'Branch 006', userId: 'E604', employeeId: 'E604', date: '2026-09-01', time: '22:05', glAccount: '7004', transactionType: 'Manual Adjustment', amount: '9100', manualEntry: 'Yes', reversal: 'Yes', authorizationUser: 'M604' },
    { transactionId: 'GL-006-02', branch: 'Branch 006', userId: 'E604', employeeId: 'E604', date: '2026-09-03', time: '23:30', glAccount: '7004', transactionType: 'Manual Adjustment', amount: '7400', manualEntry: 'Yes', reversal: 'No', authorizationUser: 'M604' },
    { transactionId: 'GL-006-03', branch: 'Branch 006', userId: 'E605', employeeId: 'E605', date: '2026-09-06', time: '21:15', glAccount: '7004', transactionType: 'Manual Adjustment', amount: '8800', manualEntry: 'Yes', reversal: 'Yes', authorizationUser: 'M604' },
    { transactionId: 'GL-007-01', branch: 'Branch 007', userId: 'E704', employeeId: 'E704', date: '2026-09-02', time: '22:40', glAccount: '7005', transactionType: 'Manual Adjustment', amount: '5600', manualEntry: 'Yes', reversal: 'No', authorizationUser: 'M704' },
    { transactionId: 'GL-007-02', branch: 'Branch 007', userId: 'E704', employeeId: 'E704', date: '2026-09-04', time: '23:05', glAccount: '7005', transactionType: 'Manual Adjustment', amount: '5100', manualEntry: 'Yes', reversal: 'No', authorizationUser: 'M704' },
    { transactionId: 'GL-007-03', branch: 'Branch 007', userId: 'E705', employeeId: 'E705', date: '2026-09-06', time: '20:50', glAccount: '7005', transactionType: 'Manual Adjustment', amount: '4900', manualEntry: 'Yes', reversal: 'Yes', authorizationUser: 'M704' },
  ],
  access: [
    { employeeId: 'E202', employeeName: 'Demo Employee', branch: 'Branch 002', accessDate: '2026-09-03', entryTime: '23:05', exitTime: '23:20', accessPoint: 'Main Entrance' },
    { employeeId: 'E304', employeeName: 'Demo Employee', branch: 'Branch 003', accessDate: '2026-09-02', entryTime: '21:35', exitTime: '21:58', accessPoint: 'Main Entrance' },
    { employeeId: 'E305', employeeName: 'Demo Employee', branch: 'Branch 003', accessDate: '2026-09-05', entryTime: '22:50', exitTime: '23:10', accessPoint: 'Back Office' },
    ...
    { employeeId: 'E604', employeeName: 'Demo Employee', branch: 'Branch 006', accessDate: '2026-09-01', entryTime: '22:00', exitTime: '22:25', accessPoint: 'Vault' },
    { employeeId: 'E604', employeeName: 'Demo Employee', branch: 'Branch 006', accessDate: '2026-09-03', entryTime: '23:15', exitTime: '23:40', accessPoint: 'Main Entrance' },
    { employeeId: 'E605', employeeName: 'Demo Employee', branch: 'Branch 006', accessDate: '2026-09-06', entryTime: '21:05', exitTime: '21:30', accessPoint: 'Back Office' },
    { employeeId: 'E704', employeeName: 'Demo Employee', branch: 'Branch 007', accessDate: '2026-09-02', entryTime: '22:35', exitTime: '22:58', accessPoint: 'Main Entrance' },
    { employeeId: 'E705', employeeName: 'Demo Employee', branch: 'Branch 007', accessDate: '2026-09-06', entryTime: '20:45', exitTime: '21:10', accessPoint: 'Back Office' },
  ],
  shortages: [
    { branch: 'Branch 003', date: '2026-09-04', tellerUserId: 'T304', employeeId: 'T304', shortageAmount: '90', currency: 'BHD', reason: 'Cash count variance', incidentReportNumber: 'INC-003-01', investigationResult: 'Open', recovered: 'No', repeatIncident: 'No' },
    { branch: 'Branch 003', date: '2026-09-07', tellerUserId: 'T304', employeeId: 'T304', shortageAmount: '140', currency: 'BHD', reason: 'Cash count variance', incidentReportNumber: 'INC-003-02', investigationResult: 'Open', recovered: 'No', repeatIncident: 'Yes' },
    ...
    { branch: 'Branch 006', date: '2026-09-01', tellerUserId: 'T604', employeeId: 'T604', shortageAmount: '310', currency: 'BHD', reason: 'Unresolved difference', incidentReportNumber: 'INC-006-01', investigationResult: 'Open', recovered: 'No', repeatIncident: 'Yes' },
    { branch: 'Branch 006', date: '2026-09-04', tellerUserId: 'T604', employeeId: 'T604', shortageAmount: '260', currency: 'BHD', reason: 'Cash count variance', incidentReportNumber: 'INC-006-02', investigationResult: 'Open', recovered: 'No', repeatIncident: 'Yes' },
    { branch: 'Branch 006', date: '2026-09-06', tellerUserId: 'T605', employeeId: 'T605', shortageAmount: '410', currency: 'BHD', reason: 'Unresolved difference', incidentReportNumber: 'INC-006-03', investigationResult: 'Open', recovered: 'No', repeatIncident: 'Yes' },
    { branch: 'Branch 007', date: '2026-09-03', tellerUserId: 'T704', employeeId: 'T704', shortageAmount: '150', currency: 'BHD', reason: 'Cash count variance', incidentReportNumber: 'INC-007-01', investigationResult: 'Open', recovered: 'No', repeatIncident: 'No' },
    { branch: 'Branch 007', date: '2026-09-06', tellerUserId: 'T704', employeeId: 'T704', shortageAmount: '190', currency: 'BHD', reason: 'Cash count variance', incidentReportNumber: 'INC-007-02', investigationResult: 'Open', recovered: 'No', repeatIncident: 'Yes' },
  ],
  incidents: [
    { incidentId: 'INC-003-01', branch: 'Branch 003', date: '2026-09-04', employeeUser: 'T304', incidentType: 'Cash shortage', description: 'Teller shortage recorded', rootCause: '', zoneManager: 'Manager 003', managementResponse: '', status: 'Open' },
    ...
    { incidentId: 'INC-006-01', branch: 'Branch 006', date: '2026-09-01', employeeUser: 'T604', incidentType: 'Cash shortage', description: 'Repeat teller shortage, escalated to zone manager', rootCause: '', zoneManager: 'Manager 006', managementResponse: '', status: 'Open' },
    { incidentId: 'INC-006-02', branch: 'Branch 006', date: '2026-09-06', employeeUser: 'T605', incidentType: 'Suspected fraud', description: 'Unusual pattern of after-hours GL adjustments under review', rootCause: '', zoneManager: 'Manager 006', managementResponse: '', status: 'Open' },
    { incidentId: 'INC-007-01', branch: 'Branch 007', date: '2026-09-03', employeeUser: 'T704', incidentType: 'Cash shortage', description: 'Teller shortage recorded', rootCause: '', zoneManager: 'Manager 007', managementResponse: '', status: 'Open' },
  ],
};
